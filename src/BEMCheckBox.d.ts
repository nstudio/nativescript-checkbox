...
declare class BEMAnimationManager extends NSObject {
	...
	fillAnimationWithBouncesAmplitudeReverse(
		bounces: number,
		amplitude: number,
		reverse: boolean
	): CAKeyframeAnimation;
...
declare class BEMCheckBox extends UIControl implements CAAnimationDelegate {
	...
	): BEMCheckBox; // inherited from UIAppearance
...
declare class BEMCheckBoxGroup extends NSObject {
	...
	static groupWithCheckBoxes(
		checkBoxes: NSArray<BEMCheckBox>
	): BEMCheckBoxGroup;
