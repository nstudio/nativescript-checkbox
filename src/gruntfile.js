module.exports = function(grunt) {
	var localConfig = {
		typeScriptDeclarations: ['index.d.ts', 'BEMCheckBox.d.ts'],
		outDir: 'bin/dist/'
	};
	...
	grunt.initConfig({
		...
		exec: {
			tsCompile: {
				cmd:
					'node ./node_modules/typescript/bin/tsc --project tsconfig.json --outDir ' +
					localConfig.outDir
			},
			ngCompile: {
				cmd:
	...
	grunt.registerTask('publish', ['build', 'exec:npm_publish']);
};
